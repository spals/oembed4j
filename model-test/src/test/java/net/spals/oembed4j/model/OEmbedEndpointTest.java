...
public class OEmbedEndpointTest {
    ...
    public void testDefaultFormatDerived(
        final OEmbedEndpoint.Builder endpointBuilder,
    ...
    Object[][] schemePatternDerivedProvider() {
        return new Object[][]{
            ...
            {"https://www.example.com/*/path/*", ImmutableSet.of("https://www.example.com/(.*)/path/(.*)")},
            {
                ...
                ImmutableSet.of("http://www.example.com/(.*)", "https://www.example.com/(.*)")
            },
        };
    }

    @Test(dataProvider = "schemePatternDerivedProvider")
    public void testSchemePatternDerived(
        ...
        final OEmbedEndpoint endpoint = new OEmbedEndpoint.Builder()
            ...
            .setURITemplate("https://www.example.com/oembed")
            .build();
        final Set<String> patterns = endpoint.getSchemePatterns().stream()
            .map(Pattern::pattern)
            .collect(Collectors.toSet());
        assertThat(patterns, is(expectedSchemePattern));
    }
    ...
    public void testURIDomainPatternDerived(
    ...
    public void testDomainMatchesResourceURI(
        final String uriTemplate,
    ...
    Object[][] schemeMatchesResourceURIProvider() {
        return new Object[][]{
            {
                ImmutableList.of("https://vimeo.com/album/*/video/*"),
                URI.create("https://vimeo.com/album/1/video/2"),
                true
            },
            {
                ImmutableList.of("https://vimeo.com/album/*/video/*"),
                URI.create("https://vimeo.com/album/1/deadbeef/2"),
                false
            },
            ...
            {
                ImmutableList.of("https://player.vimeo.com/video/*"),
                URI.create("https://player.vimeo.com/video/1"),
                true
            },
            {
                ImmutableList.of("https://player.vimeo.com/video/*"),
                URI.create("https://player.vimeo.com/video/1/2"),
                true
            },
        };
    }
    ...
    public void testSchemeMatchesResourceURI(
        final List<String> schemeTemplates,
        final URI resourceURI,
        final boolean expectedResult
    ) {
